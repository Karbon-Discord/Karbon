...
bot.on('guildMemberAdd', member => {
    bot.channels.find("478309556330430464").sendMessage(`**Welcome aboard, ${member.user}! Please welcome him/her! If you have any questions, feel free to DM one of the Developers or me!** `);
